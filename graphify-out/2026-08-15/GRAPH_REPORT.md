...
## Corpus Check
- 103 files · ~279,531 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2193 nodes · 6220 edges · 85 communities (78 shown, 7 thin omitted)
...
Cohesion: 0.07
Nodes (45): api, ApiError, authToken(), readDetail(), request(), Window, refusalReason(), streamUrl() (+37 more)
...
- **Why does `PerfumeQuery` connect `_ResultRow` to `_trial`, `TUI Confirm Dialog`, `Search TUI Screen`, `FetchResult`, `._refresh_table`, `Candidate Filtering`, `Store Timestamp Tests`, `Live Profile Validation`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `SearchScreen` connect `._refresh_table` to `TUI App & Screens`, `_ResultRow`, `Title Matcher`, `Search/Basket Domain Models`, `TUI Confirm Dialog`, `Search TUI Screen`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
