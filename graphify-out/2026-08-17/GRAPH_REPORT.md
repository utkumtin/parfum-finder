...
## Summary
- 2419 nodes · 6740 edges · 103 communities (96 shown, 7 thin omitted)
...
Cohesion: 0.19
Nodes (9): basketKey(), Block, Notice, pickVerdicts(), ResultsScreen(), SORT_LABELS, toBlocks(), TRIAL_SIZES_ML_X10 (+1 more)

### Community 30 - "Store Timestamp Tests"
Cohesion: 0.10
Nodes (14): RecentSearch, UpdateProgress, INFO, compile(), EMPTY_BASKET, FakeServer, FakeWebSocket, installFakeServer() (+6 more)
...
Cohesion: 0.12
Nodes (20): AcceptedSearch, BasketRefreshEvent, BasketReport, BasketResponse, BasketRow, BestCombination, ResultRow, ScanEvent (+12 more)
...
Cohesion: 0.13
Nodes (18): api, ApiError, Window, App(), Toast, View, UpdateDialog(), root (+10 more)
...
- **Why does `PerfumeQuery` connect `Product Extraction` to `_ResultRow`, `Title Matcher`, `Search Engine per Site`, `TUI Confirm Dialog`, `CLI Entry Points`, `TUI App Shell`, `_trial`, `Search TUI Screen`, `Candidate Filtering`, `ConfirmScreen`, `snapshot_rows`, `Live Profile Validation`?**
